...
\name{Ibragim}{Dzhiblavi}
\position{Applied Mathematics and Computer Science{\enskip\cdotp\enskip}Software Engineer}
% \address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+7) 999-203-1239}
\email{dzhiblavi@gmail.com}
\github{dzhiblavi}
\linkedin{dzhiblavi}
% \gitlab{gitlab-id}
...
\extrainfo{Russian, English (fluent)}
